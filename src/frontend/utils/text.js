const TEXT = {
  ...
  GUIDE: {
    ...
    각 플레이어는 번갈아가면서 스토리텔러가 되고, 자신이 가지고 있는 6장의 카드 중 하나를 고릅니다.
    고른 카드에 대한 주제도 함께 정합니다.

    스토리텔러를 제외한 플레이어들은 자신이 갖고 있는 6장의 카드 중 주제와 가장 유사한 카드 한 장을 고릅니다.

    모든 플레이어가 선택한 카드가 한번에 공개되면,
    스토리텔러를 제외한 플레이어는 스토리텔러가 '어떤 카드를 냈을까?' 추측하며 한 장의 카드를 고릅니다.
    `,
    CONTENT_RIGHT: `
    점수를 얻는 조건은 다음과 같습니다.
    ...
    2. 내 카드를 선택한 사람이 있는 경우 :
        +1 * (속인 사람의 수) 점

    3. 모두 정답을 맞힌 경우 : 출제자를 제외한 전원 +2점

    4. 정답자가 없는 경우 : 출제자를 제외한 전원 +2점
